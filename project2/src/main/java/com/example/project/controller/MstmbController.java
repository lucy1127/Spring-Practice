...
public class MstmbController {
    ...
    @GetMapping("/getData")
    public Mstmb getMstmbData(String stock){
        return this.mstmbService.getMstmb(stock);
    }
    ...
    @GetMapping("/stock")
    public Symbols getData(@RequestParam String stock){
        return mstmbService.getStock(stock);
    }
